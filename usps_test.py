...
def rbf_kernel(X1, X2, gamma=0.027):
...
#                       random_state=0)
X, labels = fetch_openml(data_id=41082, as_frame=False, return_X_y=True, parser='liac-arff')
...
# solving took 445.511 sec
# got  1608  of  1860  test accuracy =  0.864516129032258
